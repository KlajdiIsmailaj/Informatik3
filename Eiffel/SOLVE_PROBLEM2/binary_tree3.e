...
is_this_empty:BOOLEAN
      do
       ...
       get_root:NODE3[G]-- get root method
...
feature--check void safety of nodes and values----------------
     attached_node(a_node:detachable NODE3[G]):attached NODE3[G]
...
feature{NONE}
        delete_recursiv(c_node:NODE3[G])
